...
all_local_dirs=(
    '/next/u/heyueya/verl-stable-insights/sft/0728rubric_sft/global_step_100'
...
for i in $(seq 0 $((num_local_dirs - 1))); do
    ...
    command="python /next/u/heyueya/verl-stable-insights/scripts/upload_sft.py \
        --local_dir $LOCAL_DIR \
